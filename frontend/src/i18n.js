...
const dict = {
  en: {
    ...
    footer_hours: "Mon–Fri 8:00 AM – 6:00 PM", footer_tag: "Accredited durable medical equipment supplier serving Greater Houston.",
  ...
  es: {
    ...
    footer_hours: "Lun–Vie 8:00 AM – 6:00 PM", footer_tag: "Proveedor acreditado de equipo médico duradero para el área de Houston.",
